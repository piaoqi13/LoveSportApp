...
public class HttpTask<ResultType> extends AbsTask<ResultType> implements ProgressHandler {
        ...
        while (retry) {
            ...
            try {
                ...
                try {
                    clearRawResult();
                    // 开始请求工作
                    // LogUtil.d("xUtils：load=" + this.request.getRequestUri());
                    // CollinWang2015.12.09
                    Log.i("CollinWang", "Url=" + this.request.getRequestUri());
    ...
    protected void onSuccess(ResultType result) {
        ...
        if (result != null) {
            ...
            // CollinWang2015.12.09
            Log.i("CollinWang", "JSON=" + result.toString());
        }
    }
    ...
    protected void onError(Throwable ex, boolean isCallbackError) {
        ...
        // CollinWang2015.12.09
        Log.i("CollinWang", "Error=" + ex.toString());
    }
